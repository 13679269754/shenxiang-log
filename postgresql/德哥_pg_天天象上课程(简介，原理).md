...
![并发seq_scan](./image/并发seq_scan.png)
...
3. merge join 
   ![merge_join](<image/merge_join .png>)
   有点类似于mrr 
...
4. hash join
    ...
    ![并行hash_join](image/并行hash_join.png)
...
### 优化器设置
![执行计划](image/执行计划1.png)  

![执行计划2](image/执行计划2.png)

#### **EXPLAIN参数说明**
![explain参数说明](image/explain参数说明.png)
