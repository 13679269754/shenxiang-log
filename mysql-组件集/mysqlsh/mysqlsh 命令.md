...
#################   集群搭建   #################
## 预检查 验证搭建innodb_cluster 的前置
MySQL  localhost:33060+  JS > dba.checkInstanceConfiguration('dzjroot@172.29.105.240:3306')

## 检查实例是否适合用于 InnoDB 集群
...
################## 实例管理 ##################
## 添加节点
cluster.addInstance('dzjroot@172.29.105.241:3306')  # 输入 node2 的 root 密码

## 移除节点
cluster.removeInstance('172.29.105.240:3306');
