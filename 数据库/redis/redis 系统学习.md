...
![主从同步](数据库/redis/image.png)

![同步流程](数据库/redis/image-1.png)

![增量同步](数据库/redis/image-2.png)
复制缓冲区写满问题
...
**手动故障转移**
![手动故障转移流程](数据库/redis/image-4.png)
