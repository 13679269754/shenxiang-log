...
[MySql的InnoDB的三层B+树可以存储两千万左右条数据的计算逻辑-腾讯云开发者社区-腾讯云](https://cloud.tencent.com/developer/article/2121055) 

 关键信息
 非叶子节点主键bigint 8byte + 指针6byte



B+树是一种在非叶子节点存放排序好的索引而在叶子节点存放数据的数据结构，值得注意的是，在叶子节点中，存储的并非只是一行表数据，而是以页为单位存储，一个页可以包含多行表记录。非叶子节点存放的是索引键值和页指针。

那么，在MySql[数据库](https://cloud.tencent.com/product/tencentdb-catalog?from_column=20065&from=20065)里，一个页的大小是多少呢？

可以通过查询语句进行查看：show variables like 'innodb\_page\_size'

![](https://github.com/13679269754/shenxiang-log/blob/main/image-cubox/2025-2-13%2017-55-16/adeb28ee-e1ad-40e3-90a8-e66daf7a43ad.png?raw=true)
...
![](https://github.com/13679269754/shenxiang-log/blob/main/image-cubox/2025-2-13%2017-55-16/c59020da-1f04-4d2a-8cbb-f54fd7a0c8a7.png?raw=true)
...
![](https://github.com/13679269754/shenxiang-log/blob/main/image-cubox/2025-2-13%2017-55-16/2446400c-5835-40ed-95c3-7091d592d9ca.png?raw=true)
