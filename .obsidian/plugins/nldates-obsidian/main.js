...
class DatePickerModal extends require$$0$1.Modal {
    ...
    onOpen() {
        ...
        this.contentEl.createEl("form", {}, (formEl) => {
            ...
            new require$$0$1.Setting(formEl).setName("添加为链接？").addToggle((toggleEl) => {
...
class NLDSettingsTab extends require$$0$1.PluginSettingTab {
    ...
    display() {
        ...
        new require$$0$1.Setting(containerEl)
            .setName("分隔符")
            .setDesc("日期和时间之间的分隔符（用于同时包含日期和时间的条目）")
            .addText((text) => text
            .setPlaceholder("分隔符为空")
        ...
        new require$$0$1.Setting(containerEl)
            .setName("启用日期自动建议")
            .setDesc(`使用自然语言输入日期。使用 ${this.plugin.settings.autocompleteTriggerPhrase}`)
        ...
        new require$$0$1.Setting(containerEl)
            .setName("添加日期作为链接？")
            .setDesc("如果启用，通过自动建议创建的日期将被包裹在[[wikilinks]]中")
            .addToggle((toggle) => toggle
